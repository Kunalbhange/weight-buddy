...
import { Settings, User, Globe, Download, Trash2, ShieldCheck, CheckCircle2, AlertTriangle, Moon, Sun } from 'lucide-react';

export const SettingsPage = ({ setActiveTab }) => {
  const { user, logout, currency, changeCurrency, setStudentName, theme, toggleTheme, setTheme } = useAuth();
