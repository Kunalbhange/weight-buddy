...
import { ArrowRight, ShieldCheck, Clock, DollarSign, Bot, Activity, Check, Sparkles, Scale, Zap } from 'lucide-react';
...
export const LandingPage = ({ setActiveTab }) => {
  ...
  return (
    <div className="animate-fade-in" style={{ maxWidth: '1280px', margin: '0 auto', padding: '2rem 1.75rem' }}>
      {/* FRONT HERO SECTION WITH CHUNKY EMBEDDED BMI CALCULATOR */}
      <section style={{
        ...
        <div style={{
          ...
          <div>
            <div className="badge badge-emerald" style={{ marginBottom: '1.25rem' }}>
              <ShieldCheck size={15} /> 100% Free Forever • Zero Ads • No Credit Card
            </div>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '2.5rem' }}>
              <button className="btn-primary" onClick={() => setActiveTab('signup')} style={{ padding: '0.95rem 2.2rem', fontSize: '1rem' }}>
                Start Free Plan Now <ArrowRight size={18} />
              </button>
              <button className="btn-secondary" onClick={() => setActiveTab('login')} style={{ padding: '0.95rem 1.8rem', fontSize: '1rem' }}>
                Student Sign In
              </button>
            </div>
            ...
            <div style={{
              ...
              <span style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <Check size={16} color="var(--accent-primary)" /> Under {minPrice} – {maxPrice} / Meal
              </span>
              <span style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <Check size={16} color="var(--accent-primary)" /> Multi-Language AI Companion
              </span>
            </div>
          </div>

          {/* HERO RIGHT: CHUNKY EMBEDDED BMI CALCULATOR CARD */}
          <div className="glass-card" style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: 800, fontSize: '1.05rem' }}>
                <div style={{ width: '32px', height: '32px', borderRadius: '10px', background: 'rgba(16, 185, 129, 0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--accent-primary)' }}>
                  <Scale size={18} />
                </div>
                <span>Live Interactive BMI Engine</span>
              </div>
              <span className="badge badge-emerald" style={{ fontSize: '0.7rem' }}>Real-Time</span>
            </div>
            ...
            <div style={{
              ...
              <div>
                <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.06em', fontWeight: 800 }}>CALCULATED BMI</div>
              ...
              <div style={{ textAlign: 'right' }}>
                <div className={`badge ${metrics.badgeClass}`} style={{ fontSize: '0.78rem', padding: '0.4rem 0.9rem', marginBottom: '0.4rem' }}>
                  {metrics.category}
                </div>
      ...
      <section style={{ margin: '4.5rem 0 3.5rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          <h2 className="font-heading" style={{ fontSize: '2.2rem', fontWeight: 900, marginBottom: '0.5rem' }}>
            Built For Modern Student Life
          </h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>Everything you need for clean student nutrition and muscle goals.</p>
        </div>
        ...
        <div style={{
          ...
          <div className="glass-card glass-card-interactive" style={{ padding: '1.75rem' }}>
            <div style={{ width: '44px', height: '44px', borderRadius: '14px', background: 'rgba(16, 185, 129, 0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--accent-primary)', marginBottom: '1.25rem' }}>
              <Clock size={22} />
            </div>
            <h3 className="font-heading" style={{ fontSize: '1.2rem', marginBottom: '0.4rem' }}>Schedule Density Aware</h3>
          ...
          <div className="glass-card glass-card-interactive" style={{ padding: '1.75rem' }}>
            <div style={{ width: '44px', height: '44px', borderRadius: '14px', background: 'rgba(245, 158, 11, 0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fbbf24', marginBottom: '1.25rem' }}>
              <DollarSign size={22} />
            </div>
            <h3 className="font-heading" style={{ fontSize: '1.2rem', marginBottom: '0.4rem' }}>Student Budget Friendly</h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.88rem', lineHeight: '1.6' }}>
          ...
          <div className="glass-card glass-card-interactive" style={{ padding: '1.75rem' }}>
            ...
            <h3 className="font-heading" style={{ fontSize: '1.2rem', marginBottom: '0.4rem' }}>Multi-Language AI Companion</h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.88rem', lineHeight: '1.6' }}>
          ...
          <div className="glass-card glass-card-interactive" style={{ padding: '1.75rem' }}>
            <div style={{ width: '44px', height: '44px', borderRadius: '14px', background: 'rgba(255, 255, 255, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-primary)', marginBottom: '1.25rem' }}>
              <Activity size={22} />
            </div>
            <h3 className="font-heading" style={{ fontSize: '1.2rem', marginBottom: '0.4rem' }}>Milestone & Trend Tracking</h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.88rem', lineHeight: '1.6' }}>
      ...
      <section className="glass-card" style={{
        ...
        textAlign: 'center',
        background: 'linear-gradient(135deg, rgba(16, 185, 129, 0.12) 0%, rgba(16, 16, 20, 0.95) 100%)',
        border: '1.5px solid rgba(16, 185, 129, 0.35)',
        borderRadius: 'var(--radius-lg)'
      }}>
        <h2 className="font-heading" style={{ fontSize: '2.3rem', fontWeight: 900, marginBottom: '0.6rem' }}>
          Ready To Take Control Of Your Student Diet?
        </h2>
        <p style={{ color: 'var(--text-secondary)', fontSize: '1rem', maxWidth: '620px', margin: '0 auto 2rem' }}>
          Create your free account in under 60 seconds. No subscription traps, no external trackers.
        </p>
        <button className="btn-primary" onClick={() => setActiveTab('signup')} style={{ padding: '0.95rem 2.5rem', fontSize: '1.05rem' }}>
